...
from accelerate.utils import ProjectConfiguration, set_seed, is_tensorboard_available, is_wandb_available, DistributedDataParallelKwargs
...
def build_accelerator(cfg: Namespace) -> Accelerator:
    ...
    accelerator = Accelerator(
        ...
        kwargs_handlers=[
            DistributedDataParallelKwargs(find_unused_parameters=True), # Find unused parameters in DDP
